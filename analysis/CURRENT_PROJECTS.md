...
| **example-2** | AI concierge prompt framework for Chatbase | Markdown, Python |
...
| **Claude API** | Vordr, Aegis, example-2, claude-mods |
...
3. **Claude API** - Core to Vordr, Aegis, example-2
